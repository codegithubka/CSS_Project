...
def compute_population_variance(
...
def sample_parameter_configurations(
...
def run_soc_perturbation_experiment(
    config: Dict,
...
def track_avalanche_propagation(
    grids_history: List[np.ndarray],
...
def visualize_avalanche_details(
